...
public class CaesarCipher2 extends JFrame implements ActionListener {
    ...
    private static JButton       actionButton    = new JButton("Decrypt Message");
